$.fn.datepicker = function (options) {
    ...
    var fieldPaddingLeft = $(field).parent().css('padding-left');
    var fieldPaddingBottom = $(field).parent().css('padding-bottom');
    var fieldHeight = $(field).height() - fieldPaddingBottom;
    var offsetTop = $(field).offset().top + fieldHeight + 10;
    picker.css('top', offsetTop);
    picker.css('left', fieldPaddingLeft);
